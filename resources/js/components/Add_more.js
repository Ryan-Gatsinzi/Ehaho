...
function Add_more(){
    ...
    const purchase_product = (values)=>{
      ...
      values.products.forEach(el => {
        paid.push(el.purchase_quantity*el.purchase_unit_price)
      });                         
        axios.post('/api/add_more', {
                product_info :values, 
                purchase_channel:'Offline',
                purchase_platform:'Web',
                purchase_paid_amount:paid.reduce((a, b)=> a+b, 0)
              })
        ...
        <div className="col-lg-8 col-xl-6">
          <div className="card rounded-3">           
            <div className="card-body p-4 p-md-5">                         
              ...
              <Formik
              initialValues={{products:[{purchase_unit_price:'',purchase_quantity:'',product_discount:'', business_product_id:'', purchase_unit_package:''}],receipt_number:'',purchase_date:'', supplier_id:'',payment_method:''}}
              >
                {({
                  values,
                  handleChange,
              ...
              <FieldArray name='products'>               
                          ...
                          values.products.map((product, index)=>{  
                             ...
                             <div className="row" >                
                              <div className="col-md-6 mb-4"> 
                                <div className="form-outline datepicker" style={{paddingRight: '25px', paddingBottom: '25px'}}>
                                  ...
                                  <input type="number" className="form-control" name={`products[${index}].purchase_unit_price`} onChange={handleChange(`products[${index}].purchase_unit_price`)} placeholder="Rwanda francs"  required/>  
                            ...
                            <div className="form-outline datepicker"  style={{paddingRight: '25px', paddingBottom: '25px'}}>
                                  <label className="form-label">Quantity</label>
                                    <input type="number" name={`products[${index}].purchase_quantity`} onChange={handleChange(`products[${index}].purchase_quantity`)} className="form-control" placeholder='Quantity' required/>                                    
                                    <p className="text-danger h6"></p>                                    
                                </div>                                
                            <div className="mb-4">                                   
                              <label className="form-label">Packaging</label>                                                            
                              <select className="form-select" onChange={handleChange(`products[${index}].purchase_unit_package`)} name={`products[${index}].purchase_unit_package`}>
                ...
                <div className="form-outline datepicker" >
                  <label className="form-label">Reciept number</label>
                    <input type="number" name="receipt_number" onChange={handleChange("receipt_number")} className="form-control" placeholder='reciept number' required/>                                    
                    <p className="text-danger h6"></p>                                    
                </div>                                                                      
                <div className="mb-4">                                   
                  <label className="form-label">Supplier</label>
                  <select className="form-select" name="supplier_id" onChange={handleChange("supplier_id")}>    
                ...
                <div className="mb-4">                                   
                  ...
                  <option selected disabled value="0">Select a payment method</option>                                                        
                    ...
                    <div className="mb-3">
                        ...
                        <input name="purchase_date" type="date" className="form-control" onChange={handleChange("purchase_date")} required/>   
