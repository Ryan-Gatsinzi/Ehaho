        ...
        <div class="col-lg-8 col-xl-6">
          <div class="card rounded-3">
            ...
            <div class="card-body p-4 p-md-5">
              ...
              <form class="px-md-2" action="/purchase_product" method="POST">  
                @csrf
                <div class="row">
                  <div class="col-md-6 mb-4"> 
                    ...
                    <div class="form-outline datepicker" style="padding-right: 25px; padding-bottom: 25px;">
                      ...
                      <input type="number" class="form-control" name="minimum_order_quantity" id="exampleDatepicker1" value="{{old('minimum_order_quantity')}}"/>   
                    ...
                    <div class="form-outline datepicker"  style="padding-right: 25px; padding-bottom: 25px;">
                      <label class="form-label">Minimum order indicator</label>
                        <input type="number" name="minimum_order_indicator" class="form-control" value="{{old('minimum_order_indicator')}}"/>
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-outline datepicker"  style="padding-left: 25px; padding-bottom: 25px;">
                        ...
                        <input type="number" class="form-control" name="opening_stock" id="exampleDatepicker1" value="{{old('opening_stock')}}"/>
                        @error('minimum_order_indicator')
                          <p class="text-danger h6">{{$message}}</p>
                        @enderror 
                      </div>
                      ...
                      <div class="form-outline datepicker"  style="padding-left: 25px; padding-bottom: 25px;">
                        <label class="form-label">Price</label>
                          <input type="number" name="product_price" class="form-control" placeholder="Rwanda francs" value="{{old('product_price')}}"/>  
                          @error('product_price')
                           <p class="text-danger h6">{{$message}}</p>
                        @enderror                         
                      </div>
                ...
                <div class="mb-4">                                   
                  ...
                  <select class="form-select" name="default_unit_package" value="{{old('opening_stock')}}">
                  ...
                  @enderror   
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="product_description" class="form-control" id="exampleFormControlTextarea1" rows="3" value="{{old('product_description')}}">{{$product->default_description}}</textarea>   
